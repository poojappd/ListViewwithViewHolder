...
class ListAdapterSlowWay(val context: Context, val people:MutableList<Person>) :BaseAdapter(){
    ...
    override fun getView(index: Int, view: View?, viewGroup: ViewGroup?): View {
        ...
        val newView = layoutInflater.inflate(R.layout.layout_person_row_item,viewGroup, false)
        ...
        Log.e(TAG, "getView called $index ${textViewName?.text}")
        return newView
